...
class Ins(genpy.Message):
  _md5sum = "ea51f611cd21443d10c89d3f7950b9cc"
  _type = "vectornav/Ins"
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','uint16','uint64','uint16','float32','float32','float32','float64','float64','float32','float32','float32','float32','float32[3]','float32','float32']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_dHQH3f2d4f().pack(_x.time, _x.week, _x.utcTime, _x.insStatus, _x.yaw, _x.pitch, _x.roll, _x.latitude, _x.longitude, _x.altitude, _x.nedVelX, _x.nedVelY, _x.nedVelZ))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time, _x.week, _x.utcTime, _x.insStatus, _x.yaw, _x.pitch, _x.roll, _x.latitude, _x.longitude, _x.altitude, _x.nedVelX, _x.nedVelY, _x.nedVelZ,) = _get_struct_dHQH3f2d4f().unpack(str[start:end])
      start = end
      end += 12
...
def _get_struct_3f():
    ...
    return _struct_3f
_struct_dHQH3f2d4f = None
def _get_struct_dHQH3f2d4f():
    global _struct_dHQH3f2d4f
    if _struct_dHQH3f2d4f is None:
        _struct_dHQH3f2d4f = struct.Struct("<dHQH3f2d4f")
    return _struct_dHQH3f2d4f
